...
class tDAL
{
	var $tbltte_at_localhost__detail_training;
	var $tbltte_at_localhost__lembaga;
	var $tbltte_at_localhost__penandatangan;
	var $tbltte_at_localhost__peserta;
	var $tbltte_at_localhost__training;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "detail_training", "varname" => "tte_at_localhost__detail_training", "altvarname" => "detail_training", "connId" => "tte_at_localhost", "schema" => "", "connName" => "tte at localhost");
		$this->lstTables[] = array("name" => "lembaga", "varname" => "tte_at_localhost__lembaga", "altvarname" => "lembaga", "connId" => "tte_at_localhost", "schema" => "", "connName" => "tte at localhost");
		$this->lstTables[] = array("name" => "penandatangan", "varname" => "tte_at_localhost__penandatangan", "altvarname" => "penandatangan", "connId" => "tte_at_localhost", "schema" => "", "connName" => "tte at localhost");
		$this->lstTables[] = array("name" => "peserta", "varname" => "tte_at_localhost__peserta", "altvarname" => "peserta", "connId" => "tte_at_localhost", "schema" => "", "connName" => "tte at localhost");
		$this->lstTables[] = array("name" => "training", "varname" => "tte_at_localhost__training", "altvarname" => "training", "connId" => "tte_at_localhost", "schema" => "", "connName" => "tte at localhost");
	}
