...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "tte_at_localhost";
		$data["connName"] = "tte at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;tte;;1"; //currently unused

		$this->_connectionsIdByName["tte at localhost"] = "tte_at_localhost";
		...
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=tte;OPTION=3";
		// encription set
		...
		$connectionsData["tte_at_localhost"] = $data;
