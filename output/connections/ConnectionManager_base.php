...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "tte_at_localhost" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["lembaga"] = "tte_at_localhost";
		$connectionsIds["peserta"] = "tte_at_localhost";
		$connectionsIds["penandatangan"] = "tte_at_localhost";
		$connectionsIds["training"] = "tte_at_localhost";
		$connectionsIds["detail_training"] = "tte_at_localhost";
