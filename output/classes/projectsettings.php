...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("lembaga", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "lembaga" ] = array( "url" => "lembaga", "type" => 0 );
	$projectEntitiesReverse[ "lembaga" ] = "lembaga";
	$projectEntities[ "peserta" ] = array( "url" => "peserta", "type" => 0 );
	$projectEntitiesReverse[ "peserta" ] = "peserta";
	$projectEntities[ "penandatangan" ] = array( "url" => "penandatangan", "type" => 0 );
	$projectEntitiesReverse[ "penandatangan" ] = "penandatangan";
	$projectEntities[ "training" ] = array( "url" => "training", "type" => 0 );
	$projectEntitiesReverse[ "training" ] = "training";
	$projectEntities[ "detail_training" ] = array( "url" => "detail_training", "type" => 0 );
	$projectEntitiesReverse[ "detail_training" ] = "detail_training";
}
