...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "tte_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "detail_training", "varname" => "tte_at_localhost__detail_training", "altvarname" => "detail_training", "connId" => "tte_at_localhost", "schema" => "", "connName" => "tte at localhost");
			$dalTables[$conn->connId][] = array("name" => "lembaga", "varname" => "tte_at_localhost__lembaga", "altvarname" => "lembaga", "connId" => "tte_at_localhost", "schema" => "", "connName" => "tte at localhost");
			$dalTables[$conn->connId][] = array("name" => "penandatangan", "varname" => "tte_at_localhost__penandatangan", "altvarname" => "penandatangan", "connId" => "tte_at_localhost", "schema" => "", "connName" => "tte at localhost");
			$dalTables[$conn->connId][] = array("name" => "peserta", "varname" => "tte_at_localhost__peserta", "altvarname" => "peserta", "connId" => "tte_at_localhost", "schema" => "", "connName" => "tte at localhost");
			$dalTables[$conn->connId][] = array("name" => "training", "varname" => "tte_at_localhost__training", "altvarname" => "training", "connId" => "tte_at_localhost", "schema" => "", "connName" => "tte at localhost");
		}
	}
