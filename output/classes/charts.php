...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("lembaga" == $this->chrt_array['tables'][0])
			return true;
		if("peserta" == $this->chrt_array['tables'][0])
			return true;
		if("penandatangan" == $this->chrt_array['tables'][0])
			return true;
		if("training" == $this->chrt_array['tables'][0])
			return true;
		if("detail_training" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
